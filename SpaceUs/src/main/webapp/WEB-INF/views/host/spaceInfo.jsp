						 ...
						 <table class="col-11">
						    ...
						    <tr>
						      ...
						      <td><textarea rows="5" cols="10"
						      			 class="col-8 mb-4 mr-5 pull-right" readonly
						      	  		>${space.content}
						      	  </textarea>	 
						      </td>
							</tr>
						    ...
						    <tr>
						      ...
						      <td><input type="text" class="col-8 input-group-text mb-4 mr-5 pull-right" maxlength="11" value="${space.address }" readonly /></td>
							</tr>
						</table >
